...
<div class="bb-page-header">
    <div style="display: flex; justify-content: space-between; align-items: flex-end;">
        ...
        <div style="display: flex; gap: 16px; align-items: center;">
            <form method="get" action="<%= request.getContextPath() %>/admin/menu" style="display:flex;">
                <input type="hidden" name="page" value="search">
                <div class="bb-form-group" style="margin-bottom: 0;">
                    <input type="text" name="keyword" class="bb-input" placeholder="Search menu..." value="<%= request.getAttribute("keyword") != null ? request.getAttribute("keyword") : "" %>" style="width: 240px; border-radius: 30px; padding-left: 20px;">
                </div>
            </form>
