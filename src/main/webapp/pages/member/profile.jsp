...
<div style="display: grid; grid-template-columns: 320px 1fr; gap: 32px; align-items: start;">
    ...
    <div style="display: flex; flex-direction: column; gap: 24px;">
        ...
        <div class="bb-card" style="background: var(--bb-surface-2); padding: 24px; text-align: center;">
            ...
            <div style="font-family: var(--bb-font-display); font-size: 3rem; font-weight: 700; color: var(--bb-accent);">0</div>
        </div>
    </div>
    ...
    <div style="display: flex; flex-direction: column; gap: 32px;">
        ...
        <div style="display: grid; grid-template-columns: 1.5fr 1fr; gap: 24px;">
            <div class="bb-card" style="background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('https://images.unsplash.com/photo-1550966841-3ee3228784d7?auto=format&fit=crop&w=600&q=80') center/cover; height: 160px; display: flex; flex-direction: column; justify-content: flex-end; border: none;">
                <h4 style="font-family: var(--bb-font-display); font-size: 1.25rem; color: #fff; font-style: italic; margin-bottom: 4px;">Preferred Atmosphere</h4>
                <p style="font-size: 0.7rem; color: rgba(255,255,255,0.7); text-transform: uppercase; letter-spacing: 0.1em;">Corner Booth • Window Vista</p>
            </div>
            <div class="bb-card" style="background: var(--bb-accent-soft); border-color: var(--bb-accent); height: 160px; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; gap: 8px;">
                <i class="fa-solid fa-award" style="font-size: 2rem; color: var(--bb-accent);"></i>
                <div>
                    <div style="font-family: var(--bb-font-display); font-size: 1.1rem; color: #fff; font-weight: 700;">VIP Status</div>
                    <div style="font-size: 0.6rem; color: var(--bb-accent); text-transform: uppercase; letter-spacing: 0.1em;">Michelin Management Certified</div>
                </div>
            </div>
        </div>
