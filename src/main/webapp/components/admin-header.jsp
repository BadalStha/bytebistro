...
<div class="bb-app">
    ...
    <aside class="bb-sidebar">
        ...
        <nav class="bb-nav">
            ...
            <a href="${pageContext.request.contextPath}/admin/report" class="bb-nav-item ${pageContext.request.requestURI.contains('report') ? 'active' : ''}">
                <i class="fa-solid fa-chart-line"></i> Financial Reports
            </a>
            <a href="${pageContext.request.contextPath}/admin/tables" class="bb-nav-item ${pageContext.request.requestURI.contains('tables') ? 'active' : ''}">
