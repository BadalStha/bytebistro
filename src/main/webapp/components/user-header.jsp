    ...
    <aside class="bb-sidebar">
        ...
        <nav class="bb-nav">
            ...
            <c:if test="${not empty sessionScope.userId}">
                ...
                <a href="${pageContext.request.contextPath}/profile" class="bb-nav-item ${pageContext.request.requestURI.contains('profile') ? 'active' : ''}">
                    <i class="fa-solid fa-circle-user"></i> Profile
                </a>
                <a href="${pageContext.request.contextPath}/rating" class="bb-nav-item ${pageContext.request.requestURI.contains('rating') ? 'active' : ''}">
